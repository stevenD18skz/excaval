Inteligencia de diseño UI/UX para web y dispositivos móviles. Base de datos local con función de búsqueda que incluye más de 50 estilos, 161 paletas de colores, 57 combinaciones de fuentes, 161 tipos de productos, 99 directrices de UX y 25 tipos de gráficos en 10 plataformas (React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui y HTML/CSS). Úsela al diseñar, crear o revisar interfaces de usuario: páginas, componentes, esquemas de color, tipografía, diseño, accesibilidad, animación o visualización de datos.
